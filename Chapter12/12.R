...
soda_rule=apriori(data=Groceries, parame-ter=list(supp=0.001,conf = 0.1, minlen=2), appearance = list(default="rhs",lhs="soda"))
plot(sort(soda_rule, by="lift"), method="graph", con-trol=list(type="items"))
